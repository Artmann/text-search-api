...
The `WorkflowStepContext` is passed as the first argument to the `step.do()`
callback. It provides runtime information about the current step execution.
...
Units: second, minute, hour, day, week, month, year. Sleeping instances don't
